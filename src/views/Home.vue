  ...
  <header>
    <div class="ContainerBanner">
      <div class="container">
        ...
        <img
          class="SearchPngSetting"
          src="/HomePicture/Search.png"
          alt="Search"
        />
        <img class="SettingPng" src="/HomePicture/Setting.png" alt="Setting" />
        <label>
          <input type="checkbox" />
